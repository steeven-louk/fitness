    ...
    <Link to={`/details/${id}`} className='card col-3 '>
        ...
        <div className="card-body">
            <div className="target d-flex mb-3 gap-2">
                <span className="text-center fw-bold text-white bg-danger">{props?.item.target}</span>
                <span className="text-center fw-bold text-white bg-danger">{props?.item.bodyPart}</span>
            </div>
