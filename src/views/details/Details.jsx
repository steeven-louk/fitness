...
const Details = () => {
  ...
  const getYoutubeSearch = async () => {
    const data = await youtubeSearchData(YoutubeOptions)
      .then((data) => data)
      .catch((error) => console.log("error", error));
  ...
  const getSimilarTarget = async () => {
    const data = await similarTarget(exercise?.target)
      .then((data) => data)
      .catch((error) => console.log("error", error));
    setGetTarget(data);
  };
  ...
  const getSimilarEquipment = async () => {
    const data = await similarEquipment(exercise?.equipment)
      .then((data) => data)
      .catch((error) => console.log("error", error));
    setGetEquipment(data.data);
  };


console.log('equi', exercise?.target)
